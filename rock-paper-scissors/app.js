...
export function calculateRoundResult(playerMove, computerMove) {
  // Simplify draw conditions
  if (playerMove === computerMove) {
    return { 
      outcome: DRAW, 
      message: `Both players chose ${playerMove}. It's a draw.` 
    };
  }
  ...
  // The above conditions cover all valid game outcomes, so if none match, it's an invalid move
